...
import { updateUserStart, updateUserSuccess, updateUserFailure, deleteUserStart, deleteUserSuccess, deleteUserFailure, logout } from '../redux/user/userSlice';
      ...
      request.resource.contentType.matches('image/.*')*/}
        <img 
          ...
          <p className='text=sm self-center'>
            {imageError ? (
              <span className='text-red-700'>Error uploading image (file must be less than 10 MB)</span>) : imagePercent > 0 && imagePercent < 100 ? (
          ...
          <button className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:opacity-95 disabled:opacity-75'>{loading ? 'Loading...' : 'Update'}</button>
      </form>
